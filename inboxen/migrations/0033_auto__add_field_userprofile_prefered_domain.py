...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.prefered_domain'
        db.add_column(u'inboxen_userprofile', 'prefered_domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inboxen.Domain'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.prefered_domain'
        db.delete_column(u'inboxen_userprofile', 'prefered_domain_id')
    ...
    models = {
        ...
        u'inboxen.userprofile': {
            ...
            'prefered_domain': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inboxen.Domain']", 'null': 'True', 'blank': 'True'}),
