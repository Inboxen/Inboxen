...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Statistic.active_count'
        db.delete_column(u'inboxen_statistic', 'active_count')


    def backwards(self, orm):
        # Adding field 'Statistic.active_count'
        db.add_column(u'inboxen_statistic', 'active_count',
