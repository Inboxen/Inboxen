...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'inboxen_userprofile', 'last_activity',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 6, 16, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_activity'
        db.delete_column(u'inboxen_userprofile', 'last_activity')
    ...
    models = {
        ...
        u'inboxen.userprofile': {
            ...
            'last_activity': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 16, 0, 0)'}),
