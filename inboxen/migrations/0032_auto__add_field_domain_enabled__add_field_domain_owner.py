...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domain.enabled'
        db.add_column(u'inboxen_domain', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Domain.owner'
        db.add_column(u'inboxen_domain', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        if not db.dry_run:
            # default isn't set by default?!
            orm["inboxen.domain"].objects.update(enabled=True)


    def backwards(self, orm):
        # Deleting field 'Domain.enabled'
        db.delete_column(u'inboxen_domain', 'enabled')

        # Deleting field 'Domain.owner'
        db.delete_column(u'inboxen_domain', 'owner_id')
