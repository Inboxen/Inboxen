...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for statistic in orm.Statistic.objects.all():
            user = {}
            user["count"] = statistic.user_count
            user["new"] = statistic.new_count

            statistic.users = user
            statistic.save()

    def backwards(self, orm):
        for statistic in orm.Statistic.objects.all():
            statistic.user_count = statistic.users["count"]
            statistic.new_count = statistic.users["new"]
