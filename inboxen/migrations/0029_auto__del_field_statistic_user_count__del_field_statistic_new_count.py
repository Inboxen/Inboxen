...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Statistic.user_count'
        db.delete_column(u'inboxen_statistic', 'user_count')

        # Deleting field 'Statistic.new_count'
        db.delete_column(u'inboxen_statistic', 'new_count')


    def backwards(self, orm):
        # Adding field 'Statistic.user_count'
        db.add_column(u'inboxen_statistic', 'user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Statistic.new_count'
        db.add_column(u'inboxen_statistic', 'new_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
