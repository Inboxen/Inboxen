...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Statistic.emails'
        db.add_column(u'inboxen_statistic', 'emails',
                      self.gf('annoying.fields.JSONField')(default={}),
                      keep_default=False)

        # Adding field 'Statistic.inboxes'
        db.add_column(u'inboxen_statistic', 'inboxes',
                      self.gf('annoying.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Statistic.emails'
        db.delete_column(u'inboxen_statistic', 'emails')

        # Deleting field 'Statistic.inboxes'
        db.delete_column(u'inboxen_statistic', 'inboxes')
