...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Body.path'
        db.delete_column(u'inboxen_body', 'path')


        # Changing field 'Body.data'
        db.alter_column(u'inboxen_body', 'data', self.gf('django.db.models.fields.BinaryField')())

    def backwards(self, orm):
        # Adding field 'Body.path'
        db.add_column(u'inboxen_body', 'path',
                      self.gf('django.db.models.fields.FilePathField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Body._data'
        db.alter_column(u'inboxen_body', 'data', self.gf('django.db.models.fields.BinaryField')(null=True, db_column='data'))
