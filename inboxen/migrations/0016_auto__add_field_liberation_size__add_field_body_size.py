...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Liberation.size'
        db.add_column(u'inboxen_liberation', 'size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Body.size'
        db.add_column(u'inboxen_body', 'size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Liberation.size'
        db.delete_column(u'inboxen_liberation', 'size')

        # Deleting field 'Body.size'
        db.delete_column(u'inboxen_body', 'size')
