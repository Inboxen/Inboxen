...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Liberation.user'
        db.alter_column(u'inboxen_liberation', 'user_id', self.gf('inboxen.fields.DeferAutoOneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Liberation.user'
        db.alter_column(u'inboxen_liberation', 'user_id', self.gf('annoying.fields.AutoOneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))
