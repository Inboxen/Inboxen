    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.ForeignKey(related_name='parts', to='inboxen.Email', on_delete=django.db.models.deletion.CASCADE)),
                ('parent', mptt.fields.TreeForeignKey(related_name='children', blank=True, to='inboxen.PartList', null=True, on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefered_domain', models.ForeignKey(blank=True, to='inboxen.Domain', null=True, on_delete=django.db.models.deletion.CASCADE)),
            ],
        ),
        migrations.AddField(
            model_name='request',
        ...
        migrations.AddField(
            model_name='request',
            name='requester',
            field=models.ForeignKey(related_name='requester', to=settings.AUTH_USER_MODEL, on_delete=django.db.models.deletion.CASCADE),
        ),
        migrations.AddField(
            model_name='inbox',
            name='user',
        ...
        migrations.AddField(
            model_name='header',
            name='part',
            field=models.ForeignKey(to='inboxen.PartList', on_delete=django.db.models.deletion.CASCADE),
        ),
        migrations.AddField(
            model_name='email',
            name='inbox',
            field=models.ForeignKey(to='inboxen.Inbox', on_delete=django.db.models.deletion.CASCADE),
        ),
        migrations.AddField(
            model_name='domain',
            name='owner',
