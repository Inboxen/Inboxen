...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.date_decided'
        db.add_column(u'inboxen_request', 'date_decided',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'Request.date'
        db.alter_column(u'inboxen_request', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Request.date_decided'
        db.delete_column(u'inboxen_request', 'date_decided')


        # Changing field 'Request.date'
        db.alter_column(u'inboxen_request', 'date', self.gf('django.db.models.fields.DateTimeField')())
