...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.html_preference'
        db.delete_column(u'inboxen_userprofile', 'html_preference')


    def backwards(self, orm):
        # Adding field 'UserProfile.html_preference'
        db.add_column(u'inboxen_userprofile', 'html_preference',
