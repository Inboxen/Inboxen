...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Liberation.payload'
        db.delete_column(u'inboxen_liberation', 'payload')

        # Adding field 'Liberation.data'
        db.add_column(u'inboxen_liberation', 'data',
                      self.gf('djorm_pgbytea.lobject.LargeObjectField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Liberation.payload'
        db.add_column(u'inboxen_liberation', 'payload',
                      self.gf('django.db.models.fields.BinaryField')(null=True),
                      keep_default=False)

        # Deleting field 'Liberation.data'
        db.delete_column(u'inboxen_liberation', 'data')
