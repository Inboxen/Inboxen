...
urlpatterns = urls.patterns('',
    ...
    urls.url(r'^email/add/', views.InboxAddView.as_view(), name='inbox-add'),
    ...
    urls.url(r'^inbox/(?P<inbox>[a-zA-Z0-9\.]+)@(?P<domain>[a-zA-Z0-9\.]+)/email/(?P<id>[a-fA-F0-9]+)', views.EmailView.as_view(template_name='inbox/email.html'), name='email-view'),
    ...
    urls.url(r'^inbox/(?P<inbox>[a-zA-Z0-9\.]+)@(?P<domain>[a-zA-Z0-9\.]+)', views.SingleInboxView.as_view(template_name='inbox/inbox.html'), name='single-inbox'),
    urls.url(r'^inbox/(?P<page>\d+)', views.UnifiedInboxView.as_view(template_name='inbox/inbox.html'), name='unified-inbox'),
    urls.url(r'^inbox', views.UnifiedInboxView.as_view(template_name='inbox/inbox.html'), name='unified-inbox'),
)
