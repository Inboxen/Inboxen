...
urlpatterns = urls.patterns('',
    ...
    urls.url(r'^user/account/resurrect/(?P<inbox>[a-zA-Z0-9\.]+)@(?P<domain>[a-zA-Z0-9\.]+)', views.InboxResurrectionView.as_view(), name='user-resurrect'),
    urls.url(r'^user/account/resurrect/', views.ResurrectionSelectView.as_view(), name='user-resurrect'),
    ...
    urls.url(r'^user/account/', 'website.views.user.settings.settings.settings', name='user-settings'),
