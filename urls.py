...
urlpatterns = urls.patterns('',
    ...
    urls.url(r'^inbox/tags/(?P<tags>.*)/(?P<page>\d+)', views.TaggedInboxView.as_view(), name='tagged-inbox'),
    urls.url(r'^inbox/tags/(?P<tags>.*)/', views.TaggedInboxView.as_view(), name='tagged-inbox'),
    ...
    urls.url(r'^user/tags/(?P<tags>.*)/(?P<page>\d+)', views.TaggedHomeView.as_view(), name='tagged-home'),
    urls.url(r'^user/tags/(?P<tags>.*)/', views.TaggedHomeView.as_view(), name='tagged-home'),
    urls.url(r'^user/tags/', views.TaggedHomeView.as_view(), name='tagged-home'),
