...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='helppage',
            name='body',
            field=cms.fields.RichTextField(allow_tags=['p', 'a', 'i', 'b', 'em', 'strong', 'ol', 'ul', 'li', 'pre', 'code', 'h1', 'h2', 'h3', 'h4', 'h5'], extensions=['markdown.extensions.toc'], help_text='Markdown text, supports the TOC extension.', safe_attrs=['href', 'id'], validators=[inboxen.validators.ProhibitNullCharactersValidator()]),
        ),
        migrations.AlterField(
            model_name='image',
            name='file',
